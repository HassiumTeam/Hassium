...
namespace Hassium.HassiumObjects.Drawing
{
    public class HassiumBitmap: HassiumObject
    {
        ...
        public HassiumBitmap(HassiumObject[] cctr)
        {
            ...
            Attributes.Add("height", new InternalFunction(height, 0));
            Attributes.Add("width", new InternalFunction(width, 0));
        ...
        private HassiumObject height(HassiumObject[] args)
        {
            return new HassiumInt(Value.Height);
        }

        private HassiumObject width(HassiumObject[] args)
        {
            return new HassiumInt(Value.Width);
        }

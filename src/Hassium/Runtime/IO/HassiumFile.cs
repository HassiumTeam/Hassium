...
namespace Hassium.Runtime.IO
{
	public class HassiumFile : HassiumObject
	{
		...
		public class FileTypeDef : HassiumTypeDefinition
		{
			...
			[DocStr(
				"@dec Implements the 'enter' portion of the with statement. Does nothing.",
				"@returns null."
				)]
			[FunctionAttribute("func __enter__ () : null")]
			public static HassiumNull enter(VirtualMachine vm, HassiumObject self, SourceLocation location, params HassiumObject[] args)
			{
				return Null;
			}
